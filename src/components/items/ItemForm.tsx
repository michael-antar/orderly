  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        ...
        {/* Form */}
        <form id="item-form" onSubmit={handleSubmit} className="space-y-6 flex-1 overflow-y-auto p-2">
          {/* Name */}
          ...
          {/* Status Toggle */}
          <div className="space-y-2">
            <Label className="text-sm font-semibold">List Status</Label>
            <ToggleGroup
              type="single"
              variant="outline"
              value={formData.status}
              onValueChange={(value: Status) => {
                if (value) handleMainFieldChange('status', value);
              }}
              className="w-full"
            >
          ...
          <div className="space-y-2">
            ...
            <TagInput
              ...
              onTagsChange={(tags) => handleMainFieldChange('tags', tags)}
            />
          </div>
