...
export const CategoryManager = ({ categories, onDataChange }: CategoryManagerProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <div ref={headerRef} tabIndex={-1} className="p-6 pb-4 border-b">
          <DialogHeader>
            <DialogTitle>
              {view === 'list' ? 'My Categories' : view === 'create' ? 'Create Category' : 'Edit Category Details'}
            </DialogTitle>
            <DialogDescription>
              {view === 'list'
        ...
        <div className={`flex-1 ${view === 'list' ? 'overflow-y-auto p-6' : 'overflow-hidden flex flex-col'}`}>
          {view === 'list' ? (
              ...
              {categories.length === 0 ? (
                <div className="text-center flex flex-col items-center justify-center py-16 border-2 border-dashed rounded-xl bg-background shadow-sm">
                  ...
                  <p className="text-muted-foreground mb-6 max-w-sm">
                    You haven't created any custom categories yet. Start building your first collection!
                  </p>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">{cat.field_definitions.length} custom fields</p>
                        </div>
                      </div>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  <span className="font-bold text-destructive">ALL items</span> associated with it. This
            ...
            <CategoryBuilder categoryId={selectedCategoryId} onSave={handleBackToList} onCancel={handleBackToList} />
          )}
        </div>
