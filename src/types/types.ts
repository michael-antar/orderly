...
export type FieldType = 'string' | 'number' | 'boolean' | 'select' | 'date' | 'location';
...
export type ItemPropertyValue = string | number | boolean | LocationValue | null;
...
export type FilterOperator = 'is' | 'is_not' | 'contains' | 'gt' | 'gte' | 'lt' | 'lte';
